...
<div class="card shadow">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        ...
        <a href="form_kegiatan.php" class="btn btn-light btn-sm">+ Tambah Kegiatan</a>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table id="tblKeg" class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex gap-2">
                            <a href="form_edit_kegiatan.php?id=<?= $r['id_kegiatan'] ?>"
                                class="btn btn-sm btn-primary">
                                Edit
                            </a>
                            <a href="toggle_kegiatan.php?id=<?= $r['id_kegiatan'] ?>"
...
<script>
$(function(){ $('#tblKeg').DataTable({"pageLength":10}); setTimeout(()=>$(".alert").fadeTo(1000,0).slideUp(1000,function(){ $(this).remove() }),3000); });
</script>
</body>
</html>