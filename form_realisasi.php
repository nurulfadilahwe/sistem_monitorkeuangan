...
<head>
<meta charset="utf-8">
<title>Input Anggaran & Realisasi</title>
...
<div class="card shadow">
    <div class="card-header bg-success text-white">Input Realisasi</div>
    <div class="card-body">
    <form action="simpan_realisasi.php" method="post" class="row g-3">
        <div class="col-12">
        ...
        <div class="col-md-4">
            ...
            <input type="number" class="form-control" name="jumlah_realisasi" min="0" step="1">
        </div>
