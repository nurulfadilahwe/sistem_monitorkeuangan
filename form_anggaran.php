...
<div class="card shadow">
    <div class="card-header bg-success text-white">Input Anggaran Bulanan</div>
    <div class="card-body">
    <form action="simpan_anggaran.php" method="post" class="row g-3">
        <div class="col-12">
        ...
        <div class="col-md-6">
            <label class="form-label">Nilai Anggaran (Rp)</label>
            <input type="number" class="form-control" name="nilai_bulanan" min="0" step="1" required>
        </div>
